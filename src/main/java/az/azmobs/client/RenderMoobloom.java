...
import az.azmobs.client.layers.LayerMoobloomBloom;
...
public class RenderMoobloom extends RenderLiving<EntityMoobloom> {
    ...
    private static final ResourceLocation texture = new ResourceLocation(AzMobs.MODID, "textures/entity/moobloom.png");
