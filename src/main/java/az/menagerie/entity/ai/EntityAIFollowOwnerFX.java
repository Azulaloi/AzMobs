package az.menagerie.entity.ai;
...
public class EntityAIFollowOwnerFX extends EntityAIBase {
    ...
    public EntityAIFollowOwnerFX(EntityTameable tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
                                        ...
                                        if (this.world.isRemote) {
                                            for (int b = 0; b < 8; ++b) {
                                                this.world.spawnParticle(EnumParticleTypes.SNOWBALL,
                                                        this.tameable.posX + (this.tameable.getRNG().nextDouble() - 0.5D) * (double) this.tameable.width,
                                                        this.tameable.posY + (this.tameable.getRNG().nextDouble() * 0.6D) * (double) this.tameable.height,
                                                        this.tameable.posZ + (this.tameable.getRNG().nextDouble() - 0.5D) * (double) this.tameable.width,
                                                        0.0F, 0.0F, 0.0F);
                                            }
                                            Menagerie.logger.log(Level.DEBUG, "Gelum Warp");
                                        }
